...
console.log(`The product that will be expensive in the array is: ${Expensive(item)}`);
console.log(`Calculating the full price of all product combined: ${TotalPrice(item)}`);
console.log(`Calculating the full price of all product combined and remove product that are under the 10 dollar: ${TotalPriceExcept(item)}`);
